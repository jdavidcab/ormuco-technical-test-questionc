...
@RestController
@RequestMapping("/geo-lru-cache")
public class GeoLRUCacheController {
    ...
    public GeoLRUCacheResponse get( @RequestParam( "origin" ) String origin, 
        ...
        final String value = service.getGeoLRUCache(origin, key);
    ...
    public GeoLRUCacheResponse add( @RequestBody GeoLRUCacheRequest request ) {
        ...
        final String value = service.addGeoLRUCache( request.getOrigin(), request.getKey(), request.getValue() );
        return buildResponse( value );
